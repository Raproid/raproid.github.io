...
<div className="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
  [Use Ankr infrastructure and build blockchains](build/)↗
</div>
...
<div className="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
  [Stake, earn, and integrate](get-started/create-dApp-on-Ethereum-using-nocode)↗
</div>
...
<div className="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
  [Take your game to the Web3](get-started/create-dApp-on-Ethereum-using-nocode)↗
</div>
